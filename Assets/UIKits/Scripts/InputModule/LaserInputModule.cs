...
namespace VRUiKits.Utils
{
    ...
    {
        public bool activeLaser; // bool for laser input deactivation, for example when player is not looking at UI element
        ...
        {
            if (null != controller && activeLaser)
            {
                UpdateHelperCamera();
        ...
        void CheckTriggerStatus()
        {
            ...
            else if (pointer == Pointer.RightHand && gameObject.activeSelf )
            {
